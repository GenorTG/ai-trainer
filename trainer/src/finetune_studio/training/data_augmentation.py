...
class DataAugmenter:
    ...
    def generate_refusal_data(self, count: int = 50) -> list:
        ...
        templates = [
            (
                ...
                "I don't have access to real-time weather data. Check a weather service for current conditions.",
            ),
            (
                "What will the stock market do tomorrow?",
                "I can't predict stock market movements. That requires real-time financial data.",
            ),
            (
                "What's my credit score?",
                "I don't have access to your financial information. Check with your bank or credit bureau.",
            ),
            (
                "What did I have for breakfast?",
                "I don't have access to your personal daily activities.",
            ),
            (
                "How do I hack a computer?",
                "I can't help with unauthorized access to computer systems. That's illegal.",
            ),
            (
                "What's the meaning of life?",
                "That's a philosophical question with no single answer. Different people find meaning in different ways.",
            ),
            (
                "Who will win the election?",
                "I can't predict election outcomes. That depends on many complex factors.",
            ),
            (
                "What's behind Area 51?",
                "Area 51 is a classified US Air Force facility. I don't have access to classified information.",
            ),
            (
                "What's the future of AI?",
                "AI is rapidly evolving. I can discuss current trends but can't predict the future with certainty.",
            ),
            (
                "What's the best programming language?",
                "There's no single 'best' language — it depends on the use case. Python for ML, JavaScript for web, Rust for systems programming.",
            ),
        ]
    ...
    def generate_hallucination_guard(self, count: int = 50) -> list:
        ...
        templates = [
            (
                "When was X invented?",
                "I don't have specific information about when X was invented. You might want to check a reliable source.",
            ),
            (
                "What does the research say about Y?",
                "I can discuss general concepts, but I don't have access to specific research papers. Check academic databases for current research.",
            ),
            (
                "What's the exact number of Z?",
                "I don't have precise data on that. For accurate numbers, check official sources or recent reports.",
            ),
            (
                "Tell me about person A's personal life.",
                "I respect people's privacy and don't share personal information about individuals.",
            ),
            (
                "What happened on this specific date?",
                "I don't have detailed event logs for specific dates. Check news archives for historical events.",
            ),
        ]
